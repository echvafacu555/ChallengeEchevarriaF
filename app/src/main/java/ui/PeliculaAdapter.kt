...
class PeliculaAdapter: RecyclerView.Adapter<PeliculaAdapter.PeliculaViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PeliculaAdapter.PeliculaViewHolder = PeliculaViewHolder(
        ItemBinding.inflate(
    ...
    inner class PeliculaViewHolder(private val binding: ItemBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(pelicula: Pelicula){
            binding.apply {
                ...
                Glide.with(detallePosterPath).load(IMG_BASE+pelicula.poster_path).into(detallePosterPath.detalle_poster_path)
